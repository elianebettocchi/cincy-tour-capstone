...
const Outdoors = () => {
  ...
  <Carousel>
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
        <a href="https://www.artworkscincinnati.org/mural/fiona-and-bibi-at-the-cincinnati-zoo/" target="_blank" rel="noopener noreferrer"><Button variant="info"><i class="bi bi-info-lg"></i></Button></a>{' '}
        </Carousel.Caption>
      </Carousel.Item>
